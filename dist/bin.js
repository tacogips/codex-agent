...
async function handleFilesPatches(args) {
  const sessionId = args[0];
  if (sessionId === undefined) {
...
async function addGroup(name, description, configDir) {
  ...
  const newConfig = {
    groups: [...config.groups, toData2(group)]
  };
...
async function executeCommand(name, params, context) {
  switch (name) {
    ...
    case "session.list":
      return handleSessionList2(params, context);
    case "session.show":
      return handleSessionShow2(params, context);
    case "session.search":
    ...
    case "session.run":
      return handleSessionRun2(params);
    case "session.resume":
      return handleSessionResume2(params);
    case "session.fork":
      return handleSessionFork2(params);
    case "group.list":
      return listGroups(context.configDir);
    case "group.create":
      return handleGroupCreate2(params, context);
    case "group.show":
      return handleGroupShow2(params, context);
    case "group.add":
      return handleGroupAdd2(params, context);
    case "group.remove":
      return handleGroupRemove2(params, context);
    case "group.pause":
      return handleGroupPause2(params, context);
    case "group.resume":
      return handleGroupResume2(params, context);
    case "group.delete":
      return handleGroupDelete2(params, context);
    case "group.run":
      return handleGroupRun2(params, context);
    case "queue.list":
      return listQueues(context.configDir);
    case "queue.create":
      return handleQueueCreate2(params, context);
    case "queue.show":
      return handleQueueShow2(params, context);
    case "queue.add":
      return handleQueueAdd2(params, context);
    case "queue.pause":
      return handleQueuePause2(params, context);
    case "queue.resume":
      return handleQueueResume2(params, context);
    case "queue.delete":
      return handleQueueDelete2(params, context);
    case "queue.update":
      return handleQueueUpdate2(params, context);
    case "queue.remove":
      return handleQueueRemove(params, context);
    case "queue.move":
      return handleQueueMove2(params, context);
    case "queue.mode":
      return handleQueueMode2(params, context);
    case "queue.run":
      return handleQueueRun2(params, context);
    case "bookmark.add":
      return handleBookmarkAdd2(params, context);
    case "bookmark.list":
      return handleBookmarkList2(params, context);
    case "bookmark.get":
      return handleBookmarkGet2(params, context);
    case "bookmark.delete":
      return handleBookmarkDelete2(params, context);
    case "bookmark.search":
      return handleBookmarkSearch2(params, context);
    case "token.create":
      return handleTokenCreate2(params, context);
    case "token.list":
      return listTokens(context.configDir);
    case "token.revoke":
      return handleTokenRevoke2(params, context);
    case "token.rotate":
      return handleTokenRotate2(params, context);
    case "files.list":
      return handleFilesList2(params, context);
    case "files.patches":
      return handleFilesPatches2(params, context);
    case "files.find":
      return handleFilesFind2(params, context);
    case "files.rebuild":
...
async function subscribeCommand(name, params, context) {
  switch (name) {
    case "session.watch":
      return handleSessionWatch2(params, context);
    default:
...
async function handleSessionList2(params, context) {
  const input = params === undefined ? {} : toRecord7(params);
  const options = {};
...
async function handleSessionShow2(params, context) {
...
async function handleSessionRun2(params) {
  const input = toRecord7(params);
...
async function handleGroupCreate2(params, context) {
  const input = toRecord7(params);
  return addGroup(requireString(input, "name"), readString7(input, "description"), context.configDir);
}
async function handleGroupShow2(params, context) {
  const input = toRecord7(params);
...
async function handleGroupAdd2(params, context) {
  const input = toRecord7(params);
  const group = await findGroup(requireString(input, "id"), context.configDir);
  if (group === null) {
    throw new GraphQLError("Group not found");
...
async function handleGroupRemove2(params, context) {
  const input = toRecord7(params);
  const group = await findGroup(requireString(input, "id"), context.configDir);
  if (group === null) {
    throw new GraphQLError("Group not found");
...
async function handleGroupPause2(params, context) {
...
async function handleGroupResume2(params, context) {
...
async function handleGroupDelete2(params, context) {
...
async function handleGroupRun2(params, context) {
  const input = toRecord7(params);
  const group = await findGroup(requireString(input, "id"), context.configDir);
  if (group === null) {
    throw new GraphQLError("Group not found");
...
async function handleQueueCreate2(params, context) {
  const input = toRecord7(params);
  return createQueue(requireString(input, "name"), requireString(input, "projectPath"), context.configDir);
}
async function handleQueueShow2(params, context) {
...
async function handleQueueAdd2(params, context) {
  const input = toRecord7(params);
...
async function handleQueuePause2(params, context) {
...
async function handleQueueResume2(params, context) {
...
async function handleQueueDelete2(params, context) {
...
async function handleQueueUpdate2(params, context) {
  const input = toRecord7(params);
...
async function handleQueueMove2(params, context) {
  const input = toRecord7(params);
...
async function handleQueueMode2(params, context) {
  const input = toRecord7(params);
...
async function handleQueueRun2(params, context) {
  const input = toRecord7(params);
  const queue = await findQueue(requireString(input, "id"), context.configDir);
  if (queue === null) {
    throw new GraphQLError("Queue not found");
...
async function handleBookmarkAdd2(params, context) {
  const input = toRecord7(params);
  return addBookmark({
...
async function handleBookmarkList2(params, context) {
  const input = params === undefined ? {} : toRecord7(params);
...
async function handleBookmarkGet2(params, context) {
...
async function handleBookmarkDelete2(params, context) {
...
async function handleBookmarkSearch2(params, context) {
  const input = toRecord7(params);
  return searchBookmarks(requireString(input, "query"), { limit: readNumber5(input, "limit") }, context.configDir);
}
async function handleTokenCreate2(params, context) {
  const input = toRecord7(params);
