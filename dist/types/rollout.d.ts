...
export type ResponseItem = ResponseItemMessage | ResponseItemReasoning | ResponseItemLocalShellCall | ResponseItemFunctionCall | ResponseItemFunctionCallOutput | ResponseItemOther;
 ...
 */
export type EventMsg = UserMessageEvent | AgentMessageEvent | AgentReasoningEvent | TurnStartedEvent | TurnCompleteEvent | TurnAbortedEvent | TokenCountEvent | ExecCommandBeginEvent | ExecCommandEndEvent | ContextCompactedEvent | ErrorEvent | SessionConfiguredEvent | ThreadNameUpdatedEvent | GenericEvent;
...
export type MessageOrigin = "user_input" | "system_injected" | "tool_generated" | "framework_event";
...
export type RolloutItem = RolloutItemSessionMeta | RolloutItemResponseItem | RolloutItemEventMsg | RolloutItemCompacted | RolloutItemTurnContext;
/**
...
export declare function isSessionMeta(item: RolloutLine): item is RolloutLine & {
    type: "session_meta";
    payload: SessionMetaLine;
};
export declare function isResponseItem(item: RolloutLine): item is RolloutLine & {
    type: "response_item";
    payload: ResponseItem;
};
export declare function isEventMsg(item: RolloutLine): item is RolloutLine & {
    type: "event_msg";
    payload: EventMsg;
};
export declare function isCompacted(item: RolloutLine): item is RolloutLine & {
    type: "compacted";
    payload: CompactedItem;
};
export declare function isTurnContext(item: RolloutLine): item is RolloutLine & {
    type: "turn_context";
